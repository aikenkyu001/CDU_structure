...
媒体 $M$ から $M'$ への知能構造の転移は、単なる比喩ではなく、以下の数学的条件を満たす**構造保存写像（Structure-preserving map）** $\phi$ の存在として定義される。知能の多重実現可能性（Multiple Realizability）は、神経系のみならず非神経系や人工物においても C-D-U 構造が同型に現れ得ることを示唆している (Rouleau & Levin, 2023) [ENEURO.0375-23.2023.full.pdf]; (Fagan, 2025) [physical_theory_intelligence.pdf]。
