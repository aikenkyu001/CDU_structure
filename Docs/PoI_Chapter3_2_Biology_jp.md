...
また、900 µC で観測された成功率の消失（n=1）については、単なる線形モデルでは説明不能な知能の非線形性を裏付けている。これは過剰刺激による「生物学的な不応期」、あるいは PKGF 理論における「構築（C）と散逸（D）の非線形なバランス崩壊」を示唆しており、生物知能が単なるスイッチではなく、動的な安定性（Homeostasis）を伴う物理系であることを示している。
